...
if(event.toElement){let isPreviewElementClicked=isClassInElementTree(event.toElement,"item-expander","grid-container")
isCloseTriggeringElement(event.toElement)?hidePreview():currentPreview&&(currentPreview.item===clickedItem)&&!isPreviewElementClicked?hidePreview():!isPreviewElementClicked?showPreview(clickedItem):null}else{let isPreviewElementClicked=isClassInElementTree(event.target,"item-expander","grid-container")
isCloseTriggeringElement(event.target)?hidePreview():currentPreview&&(currentPreview.item===clickedItem)&&!isPreviewElementClicked?hidePreview():!isPreviewElementClicked?showPreview(clickedItem):null}})
return item}
