...
let isPreviewElementClicked=isClassInElementTree(event.toElement,"item-expander","grid-container")
isCloseTriggeringElement(event.toElement)?hidePreview():currentPreview&&(currentPreview.item===clickedItem)&&!isPreviewElementClicked?hidePreview():!isPreviewElementClicked?showPreview(clickedItem):null})
return item}
